...
### set the ip_forward value to 1 and uncomment if commented out
...
apt-get update -qq
apt-get -qq -y  --allow-unauthenticated install podman cri-tools
...
### old-style key install for gpg
wget -qO - https://pkgs.k8s.io/core:/stable:/v1.27/rpm/repodata/repomd.xml.key | apt-key add -
wget -qO - https://pkgs.k8s.io/core:/stable:/v1.28/rpm/repodata/repomd.xml.key | apt-key add -
wget -qO - https://pkgs.k8s.io/core:/stable:/v1.29/rpm/repodata/repomd.xml.key | apt-key add -
...
echo "deb [trusted=yes,signed-by=/etc/apt/keyrings/kubernetes-1-27-apt-keyring.gpg] https://pkgs.k8s.io/core:/stable:/v1.27/deb/ /" | sudo tee -a /etc/apt/sources.list.d/kubernetes.list
echo "deb [trusted=yes,signed-by=/etc/apt/keyrings/kubernetes-1-28-apt-keyring.gpg] https://pkgs.k8s.io/core:/stable:/v1.28/deb/ /" | sudo tee -a /etc/apt/sources.list.d/kubernetes.list
echo "deb [trusted=yes,signed-by=/etc/apt/keyrings/kubernetes-1-29-apt-keyring.gpg] https://pkgs.k8s.io/core:/stable:/v1.29/deb/ /" | sudo tee -a /etc/apt/sources.list.d/kubernetes.list
apt-get --allow-unauthenticated update
